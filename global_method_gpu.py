...
def global_method():
    path_a = './images/Yoda.jpg'
    path_b = './images/Darth-Vader.jpg'
    path_c = './images/Stormtrooper.jpg'
    path_d = './images/Ewok.jpg'
    train_name = 'global_starwars_ann_gpu'
    paths = [path_a, path_b, path_c, path_d]
    gbm = GlobalMethod(paths, 400, 0.1, 0, radius=40, device=torch.device('cuda:1'))
    # gbm.load_data(train_name)
    gbm.optimize(9000000, train_name)
    # gbm.load_data(train_name)
